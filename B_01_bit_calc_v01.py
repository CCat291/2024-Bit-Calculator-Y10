...
- Choose a file type: integer, image, text, i (integer or image)
- Enter the value of your chosen file type
- Enter xxx when ready to exit the program
    ''')
...
# calculates how many bits are needed to represent an integer
def integer_calc():
    # Ask user to enter an integer (more than / equal to 0)
